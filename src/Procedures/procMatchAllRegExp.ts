import type { MatchAllRegExpIndicesResult } from '../helpers/evaluateRegExp.js';
...
export type ResponseMatchAllRegExp = Response<MatchAllRegExpResponseType, MatchAllRegExpIndicesResult>;
