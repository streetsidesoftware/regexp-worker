import type { MatchAllRegExpArrayIndicesResult } from '../helpers/evaluateRegExp.js';
...
export type ResponseMatchAllRegExpArray = Response<MatchRegExpArrayResponseType, MatchAllRegExpArrayIndicesResult>;
